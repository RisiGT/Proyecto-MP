...
public class GestorCombate {
    ...
    private int poder1;
    private int poder2;
    private int defensa1;
    private int defensa2;
    private int salud1;
    private int salud2;
    ...
    private ArrayList<Esbirro> listaEsbirrosPers1 = new ArrayList<Esbirro>();
    private ArrayList<Esbirro> listaEsbirrosPers2 = new ArrayList<Esbirro>();
    ...
    public GestorCombate(Personaje p1, Personaje p2, int oroApostado, int oroDesafiado, String desafiante, String desafiado) {
        pers1 = p1;
        pers2 = p2;
        defensa1 = 0;//p1.getArmaduraActiva().getModDefensa() + p1.getArmaActiva().getModDefensa() + p1.getHabilidadEspecial().getDefensa(); 
        defensa2 = 0;//p2.getArmaduraActiva().getModDefensa() + p2.getArmaActiva().getModDefensa() + p2.getHabilidadEspecial().getDefensa();
    ...
    public void generarCombate() {
        ...
        if (salud1 != 0) {
            comb.setGanador(desafiado);
        } else {
            comb.setGanador(desafiante);
        }
        ...
        comb.setOroApostado(oroApostado);
        comb.setOroDesafiado(oroDesafiado);
        comb.setDesafiante(desafiante);
        comb.setDesafiado(desafiado);
        this.combate = comb;
    }
