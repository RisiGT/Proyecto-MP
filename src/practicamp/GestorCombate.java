...
public GestorCombate(Personaje p1, Personaje p2){
 ...
 public Ronda nuevaRonda(){ 
     ...
     poder1=pers1.getPoder()+pers1.getArmaActiva().getAtaque()+pers1.getArmaduraActiva().getAtaque()-pers1.getDebilidades().get(1).getValor()+pers1.getFortalezas().get(1).getValor();
        ...
        poder2=pers2.getPoder()+pers2.getArmaActiva().getAtaque()+pers2.getArmaduraActiva().getAtaque()-pers2.getDebilidades().get(1).getValor()+pers2.getFortalezas().get(1).getValor();
